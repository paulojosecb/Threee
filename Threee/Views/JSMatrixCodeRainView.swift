...
fileprivate class JSMatrixDataSource{
    ...
    static func getBrightnessAttributes(brightness: CGFloat) -> [NSAttributedString.Key: Any]{
        return [
            NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue) : UIColor.init(hue: 127.0/360.0, saturation: 97.0/100.0, brightness: brightness, alpha: 1.0),
            NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): UIFont(name: "Matrix Code NFI", size: 17)!,
            NSAttributedString.Key(rawValue: NSAttributedString.Key.shadow.rawValue): {
                    let shadow = NSShadow()
